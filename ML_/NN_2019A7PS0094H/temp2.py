...
wh2=np.random.randn(hidden_nodes,hidden_nodes2)
bh2=np.random.randn(1,hidden_nodes2)
wo=np.random.randn(hidden_nodes2,output_nodes)
...
for itr in range(50000):
	...
	wh2-=rate*dcost_dwh2
	bh2-=rate*dcost_dzh2.sum(axis=0)
